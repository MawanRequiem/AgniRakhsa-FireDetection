...
> Design context: [web/.impeccable.md](file:///e:/Ifrit-FireDetection/web/.impeccable.md)
...
#### [MODIFY] [index.html](file:///e:/Ifrit-FireDetection/web/index.html)
- Change `lang="id"` → `lang="en"`
- Change title from `Ifrit — SCADA Terminal` → `IFRIT — Fire Detection Monitor`
- Replace Inter font import with **Plus Jakarta Sans** (professional, distinctive, not Inter)
- Keep JetBrains Mono for data readouts

#### [MODIFY] [index.css](file:///e:/Ifrit-FireDetection/web/src/index.css)
...
#### [MODIFY] [Sidebar.jsx](file:///e:/Ifrit-FireDetection/web/src/components/layout/Sidebar.jsx)
- Rebrand logo: "Ifrit" → "IFRIT"
...
#### [MODIFY] [Header.jsx](file:///e:/Ifrit-FireDetection/web/src/components/layout/Header.jsx)
- Add missing routes to `pageTitles` map (`/devices`: "Devices")
- Change fallback title from "Ifrit" to "IFRIT"
- Remove dynamic import in logout handler — use existing top-level import
- Change hardcoded user info from "Admin Security" / "admin@Ifrit.local" to use auth store
- Replace amber `[ View Log ]` style accent with IFRIT red
- Update `StatusDot` labels from Indonesian to English

#### [MODIFY] [MainLayout.jsx](file:///e:/Ifrit-FireDetection/web/src/components/layout/MainLayout.jsx)
...
#### [MODIFY] [Login.jsx](file:///e:/Ifrit-FireDetection/web/src/pages/Login.jsx)
...
- Rebrand: "Ifrit" → "IFRIT", "Intelligent Indoor Fire Detection" → "AI-Powered Fire Detection"
...
- Change footer: "Ifrit Systems - PBL PNJ" → "IFRIT Fire Detection"

---

### Phase 4: Dashboard Page (Enrich + Rebrand)

#### [MODIFY] [Dashboard.jsx](file:///e:/Ifrit-FireDetection/web/src/pages/Dashboard.jsx)
...
#### [MODIFY] [MetricCard.jsx](file:///e:/Ifrit-FireDetection/web/src/components/dashboard/MetricCard.jsx)
...
#### [MODIFY] [SensorsOverview.jsx](file:///e:/Ifrit-FireDetection/web/src/components/dashboard/SensorsOverview.jsx)
...
#### [MODIFY] [DevicesTable.jsx](file:///e:/Ifrit-FireDetection/web/src/components/dashboard/DevicesTable.jsx)
...
#### [MODIFY] [AlertFeed.jsx](file:///e:/Ifrit-FireDetection/web/src/components/dashboard/AlertFeed.jsx)
...
#### [MODIFY] [Rooms.jsx](file:///e:/Ifrit-FireDetection/web/src/pages/Rooms.jsx)
...
#### [MODIFY] [RoomCard.jsx](file:///e:/Ifrit-FireDetection/web/src/components/dashboard/RoomCard.jsx)
...
#### [MODIFY] [DeviceManagement.jsx](file:///e:/Ifrit-FireDetection/web/src/pages/DeviceManagement.jsx)
...
#### [MODIFY] [StatusIndicator.jsx](file:///e:/Ifrit-FireDetection/web/src/components/ui/StatusIndicator.jsx)
- Translate Indonesian labels: "Aman" → "Safe", "Peringatan" → "Warning", "BAHAYA" → "Critical"
- Add `aria-label` for accessibility

#### [MODIFY] [AlertItem.jsx](file:///e:/Ifrit-FireDetection/web/src/components/dashboard/AlertItem.jsx)
- Remove `hazard-stripe` usage on critical alerts → use solid red-tinted background instead

#### [MODIFY] [StatCard.jsx](file:///e:/Ifrit-FireDetection/web/src/components/dashboard/StatCard.jsx)
- Replace hard-coded amber `rgba(245, 158, 11, 0.1)` with IFRIT red token

#### [MODIFY] [RoomDetail.jsx](file:///e:/Ifrit-FireDetection/web/src/pages/RoomDetail.jsx)
- Replace "Configure via /api/v1/cameras/" with "Go to Devices to register a camera"
- Translate Indonesian HoverClue text

#### [MODIFY] [App.jsx](file:///e:/Ifrit-FireDetection/web/src/App.jsx)

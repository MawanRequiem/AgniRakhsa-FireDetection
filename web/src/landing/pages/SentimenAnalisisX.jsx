      ...
      <div className="container-wide">
        <ScrollReveal>
          <div className="text-center mb-16 space-y-4">
            ...
            <p className="text-text-on-dark-muted text-lg max-w-2xl mx-auto italic">
        ...
        <section className="mt-32 space-y-10">
          <ScrollReveal>
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
              <div className="space-y-2">
                ...
                <h2 className="text-4xl font-display font-bold text-white italic">REFERENSI <span className="opacity-30">KATA</span></h2>
              </div>
              <div className="flex flex-wrap gap-2 p-1.5 bg-white/5 rounded-xl border border-white/10">
                {['all', 'negative', 'positive', 'netral', 'konflik'].map((f) => (
                  <button
                    ...
                    className={`px-5 py-2 rounded-lg text-[10px] font-bold uppercase tracking-widest transition-all cursor-pointer ${
                      activeFilter === f 
          ...
          <div className="max-h-[600px] overflow-y-auto pr-4 scrollbar-thin scrollbar-thumb-ifrit-red/30 scrollbar-track-transparent">
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              <AnimatePresence>
                {filteredExamples.slice(0, 25).map((item, index) => (
                  <motion.div
                    key={index}
                    layout
                  ...
                  >
                    <div className="flex justify-between items-start mb-4">
                      ...
                      <span className="text-[10px] font-bold tracking-widest opacity-30 group-hover:opacity-100 transition-opacity" style={{ color: THEME[item.label].color }}>
                        {THEME[item.label].label}
                      </span>
                    </div>
                    <p className="text-text-on-dark-muted text-sm italic leading-relaxed group-hover:text-white transition-colors">
                      "{item.text}"
                    </p>
                  </motion.div>
                ))}

...
const char* API_BASE_URL = "http://host.wokwi.internal:8000/api/v1";

// --- Device Configuration ---
const char* DEVICE_NAME = "IFRIT_ESP32_WOKWI";
const char* ROOM_NAME = "Wokwi Mock Room"; 
...
const char* SENSOR_TYPES[NUM_SENSORS] = {
    ...
    "SHTC3_TEMP", 
    "FLAME"
    // "SHTC3_HUMIDITY" is omitted intentionally to keep demo simple, can be added later
};
...
const float ALARM_THRESHOLDS[NUM_SENSORS] = {
    ...
    600.0,  // MQ9B (ppm)
    45.0,   // TEMP (Celsius)
    2000.0  // FLAME (Raw ADC - lower is flame!) NOTE: Flame is pull-up, check logic
};
